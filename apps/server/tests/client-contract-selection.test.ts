...
import { readClientUiComponentContracts } from "../../../plugins/ragents.actor-programs/server/client-contracts.ts";
...
import { actorProgramAuthoringContracts } from "../../../plugins/ragents.actor-programs/server/authoring-contracts.ts";
import { appPackageSchema, appContractSchema, serverApiDeclarations, installServerSdk } from "../../../plugins/ragents.actor-programs/server/app-project.ts";
import { clientDeclarations, clientApiDeclarations } from "../../../plugins/ragents.actor-programs/server/client-compiler.ts";
...
test("selected UI declarations follow aliased reexports and recursive types without unrelated exports", async () => {
  ...
  const folder = path.join(directory, "plugins/ragents.actor-programs/client-ui");
  try {
