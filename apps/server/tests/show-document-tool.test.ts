...
import type { ToolScope } from "@aicontainer/ragents";
...
test("show_document akzeptiert den absoluten Ablagepfad", async () => {
  const result = await show({ title: "Datei", path: "$RAGENTS_FILES_DIR/thema/datei.md" });
