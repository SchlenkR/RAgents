...
const workflow = async (t: TestContext) => {
    ...
    const executor = new NodeTypeScriptExecutor({ directoryFor: () => path.join(directory, "native-programs"), serverProcessContextFor });
    ...
    const runtime = new ActorProgramRuntime({
        ...
        reservedToolNames: () => [], serverProcessContextFor,
