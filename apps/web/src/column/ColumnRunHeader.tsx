...
/** Die Kopfzeile der Spalte: eine Zeile mit Titel und Zustand, die Kopfzeilenbeiträge der Plugins hinter dem Titel als Popover. */
export function ColumnRunHeader({ attention, contributions, navigation, registry, runError, session, working }: {
