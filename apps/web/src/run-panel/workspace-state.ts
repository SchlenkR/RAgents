...
/** Persönlicher Zustand der Arbeitsbereichs-Tabs im Run-Panel je Run: der offene Reiter (null: Tab-Fläche geschlossen) und die Höhe der Tab-Fläche. */
...
/** Über der Tab-Fläche bleibt immer Platz für ein Stück Chat. */
...
export function parseRunPanelWorkspaceState(raw: string | null): RunPanelWorkspaceState {
  ...
  if (!value || typeof value !== "object" || Array.isArray(value)
    ...
    throw new Error("Der gespeicherte Zustand der Arbeitsbereichs-Tabs ist ungültig.");
  }
  return value as RunPanelWorkspaceState;
}

/** Der Reiter der offenen Tab-Fläche; leer, wenn sie geschlossen ist oder der gemerkte Reiter gerade nicht verfügbar ist. */
