...
Protokolle vor dem 20.09.2026 beschreiben die alte Dateiablage über `$RAGENTS_FILES_DIR`;
diese Variable gibt es nicht mehr, heute führt allein das Werkzeug `document_write` in die
Ablage (`docs/decisions.md`, 20.09.2026).
...
Geprüft nach dem ausdrücklich erlaubten core-Neustart gegen Port 3000 mit
...
Alle zuvor vorhandenen regulären Runs wurden auf ausdrücklichen Auftrag des Owners gelöscht.
