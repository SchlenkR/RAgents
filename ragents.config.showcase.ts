// Schaufenster: das Profil core und zusätzlich die mitgelieferten Beispiele aus ragents.reference.
...
export const config = {
  ...
  "ragents.model-relay": {
    RELAY_MODELS: ["showcase-standard=openrouter/z-ai/glm-5.3-flash", "showcase-coordinator=openrouter/deepseek/deepseek-v4-flash-0731"],
  },
