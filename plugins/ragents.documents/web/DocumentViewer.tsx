...
import { Markdown } from "@aicontainer/web/chat/Markdown";
    ...
    return (
      <Empty className="h-full gap-2 p-7">
        <EmptyHeader>
          ...
          <EmptyDescription>Dateien aus der Ablage des Laufs, Ergebnisse und im Chat gezeigte Dokumente sammeln sich hier.</EmptyDescription>
        </EmptyHeader>
      </Empty>
    );
  }
