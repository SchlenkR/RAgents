...
import { Alert, AlertAction, AlertDescription, Button, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@aicontainer/web/ui";
import { thinkingLabel } from "@aicontainer/web/lib/labels";
import type { ProductModelDraft, ProductModelSettings as Settings } from "../model-settings-contract";
import { modelDraftOf, requestProductModelSettings } from "./model-settings";
import { modelDefaultsChangedEvent } from "@aicontainer/web/model-settings-events";
