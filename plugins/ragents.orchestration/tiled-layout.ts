...
export const canvasTileChatInput = (root: CanvasTileNode | null | undefined, entity: string): boolean =>
  !root ? true : "entity" in root
    ? root.entity !== entity || root.chatInput !== false
    : canvasTileChatInput(root.children[0], entity) && canvasTileChatInput(root.children[1], entity);
