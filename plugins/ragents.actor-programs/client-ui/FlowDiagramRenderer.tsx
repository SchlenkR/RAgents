...
import { Button, cn } from "../../../apps/web/src/ui";
import type { CardNode, GraphBounds, RouteEdge } from "./FlowDiagram";

const statusLabels = { pending: "Ausstehend", active: "Aktiv", done: "Fertig", blocked: "Blockiert", skipped: "Übersprungen" };
