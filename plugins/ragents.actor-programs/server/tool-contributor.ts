...
import { defineRunFunction, defineToolAvailability, holdsUsable, type RunFunction, type ToolContributor } from "@aicontainer/ragents";
...
const metadata = [
    ...
    { name: "actor_view_set_visibility", label: "Show or hide Actor View", description: "Set Canvas visibility by package-name/view-key or @handle/view-key.", longDescription: "Use names you chose; the server resolves the view ID. A unique view title also works." },
