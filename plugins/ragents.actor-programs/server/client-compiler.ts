...
import { canonicalTypeScriptBuildContract, typeScriptTypeFromSchema, type VirtualTypeScriptDiagnostic } from "@aicontainer/ragents";
...
const uiSource = fileURLToPath(new URL("../client-ui/index.tsx", import.meta.url));
...
export const installClientSdk = async (directory: string, contracts: ClientContracts): Promise<void> => {
  ...
  const files: Record<string, string> = {
    ...
    "ui.d.ts": 'export * from "./contracts/plugins/ragents.actor-programs/client-ui/contracts";\n',
