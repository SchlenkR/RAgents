...
function reference(catalog: HomepageCatalog, ui: Awaited<ReturnType<typeof buildHomepageUi>>) {
  ...
  return `<div class="intro"><p class="eyebrow">Referenz / vorhandene Bausteine</p><h1>Funktionen, Oberflächen und Abläufe</h1><p class="lead">RAgents verbindet KI-Agenten mit typisierten Funktionen und kleinen Bedienoberflächen. Einmalige TypeScript-Snippets und dauerhafte Actor-Programme verwenden dieselbe API. Eine Unterhaltung mit ihren Beteiligten und Ergebnissen heißt Run. Diese Referenz zeigt die verfügbaren Bausteine und vorbereiteten Abläufe der Grundausstattung core.</p><p>Den Aufbau erklärt der <a href="guide.html">Guide</a>. Eigene Erweiterungen bauen: Die <a href="developer.html">Entwicklerreferenz</a> erklärt die Erweiterungspunkte mit kleinen Beispielen. Die <a href="rpc-api.md">JSON-RPC-API</a> beschreibt, wie andere Programme Unterhaltungen verwalten können; den maschinenlesbaren Vertrag gibt es als <a href="openrpc.json">OpenRPC-Datei</a>.</p><p class="stats">${catalog.tools.length} Funktionen / ${ui.components.length} UI-Komponenten / ${catalog.templates.length} Actor-Programm-Vorlagen / ${catalog.starts.length} Einstiege</p><nav class="section-nav" aria-label="Auf dieser Seite"><a href="#tools">Funktionen</a><a href="#ui">UI ausprobieren</a><a href="#templates">Vorlagen</a><a href="#examples">Beispiele</a><a href="#walkthroughs">Bedienbeispiele</a><a href="#starts">Einstiege</a><a href="#operations">Operationen</a><a href="#plugins">Plugins</a></nav></div>
