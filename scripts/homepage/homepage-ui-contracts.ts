...
import { readClientUiContractFiles } from "../../apps/server/src/plugin-support/actor-programs/client-contracts.js";
...
const contractEntry = "apps/web/src/actor-programs/client-ui/contracts.d.ts";
const runtimeEntry = "apps/web/src/actor-programs/client-ui/index.tsx";
...
const hostPackagePaths = {
  "@ragents/host/*": ["apps/server/src/*"],
  "@ragents/web/*": ["apps/web/src/*"],
  "@ragents/plugins/*": ["plugins/*"],
};
