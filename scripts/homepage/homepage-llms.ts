...
export function buildHomepageLlms(catalog: HomepageCatalog, extensions: HomepageExtensionsResult, guide: HomepageGuide): Record<string, string> {
  ...
  const index = document([
    "# RAgents",
    "> Programmierbarer AI-Harness mit Chat, mehreren Agenten, TypeScript-Actors und kleinen Bedienoberflächen auf einer Kachelfläche.",
    ...
    "- [Guide](guide.md): Einstieg, Laufzeit, Zugänge, verteiltes Arbeiten, TypeScript-Funktionen, Mini-Apps, Erweiterungen und Rechte aus der aktuellen Dokumentation.",
