...
- Prozessleiste eines Runs auf einem Arbeitsplatz: die markierten Prozesse, die auf dem Server laufen (TypeScript-Plattform, Actor-Programme), fehlen; der Stopp räumt sie ab, einzeln beenden lassen sie sich nicht (Review Arbeitsbereich 24.09.2026). Beide Executoren zusammenführen oder die Grenze in der Spec nennen.
...
- Echter Run unter Windows mit `connect`, `read`, `edit`, `bash` und Diagnostik (Paket 7 vom 20.09.2026); einen Windows-Rechner gibt es hier nicht.
