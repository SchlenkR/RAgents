...
- Die erzeugten Referenzen `docs/homepage/openrpc.json`, `rpc-api.md` und `guide-access.*` kennen `ragents.overseer.coordinator` und den Koordinator je Benutzer noch nicht; beim nächsten Homepage-Build neu erzeugen (24.09.2026).
