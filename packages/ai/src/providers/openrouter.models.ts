...
export const OPENROUTER_MODELS = {
	...
	"anthropic/claude-opus-4.1:batch": {
		...
		reasoning: true,
		input: ["image", "text", "file"],
		cost: {"input":7.5,"output":37.5,"cacheRead":0.75,"cacheWrite":9.375},
		contextWindow: 200000,
		maxTokens: 32000,
	} satisfies Model<"openai-completions">,
	...
	"deepseek/deepseek-v4-flash-0731": {
		...
		input: ["text"],
		cost: {"input":0.065,"output":0.18,"cacheRead":0.016,"cacheWrite":0},
	...
	"deepseek/deepseek-v4-pro-0813:batch": {
		...
		thinkingLevelMap: {"off":"none","minimal":null,"low":null,"medium":null,"high":"high","xhigh":"xhigh","max":null},
		input: ["text"],
		cost: {"input":1.32,"output":3.96,"cacheRead":0.13,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 943718,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-2.5-flash:batch": {
		...
		reasoning: true,
		input: ["file", "image", "text", "audio", "video"],
		cost: {"input":0.15,"output":1.25,"cacheRead":0.03,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 65535,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-2.5-pro:batch": {
		...
		input: ["text", "image", "file", "audio", "video"],
		cost: {"input":0.625,"output":5,"cacheRead":0.125,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 65536,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-3.1-flash-lite:batch": {
		...
		thinkingLevelMap: {"off":"none","minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":null,"max":null},
		input: ["text", "image", "video", "file", "audio"],
		cost: {"input":0.125,"output":0.75,"cacheRead":0.0125,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 65536,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-3.1-pro-preview:batch": {
		...
		input: ["audio", "file", "image", "text", "video"],
		cost: {"input":1,"output":6,"cacheRead":0,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 65536,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-3.6-flash:batch": {
		...
		thinkingLevelMap: {"off":null,"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":null,"max":null},
		input: ["text", "image", "video", "file", "audio"],
		cost: {"input":0.375,"output":1.875,"cacheRead":0.0375,"cacheWrite":0.041667},
		contextWindow: 1048576,
		maxTokens: 65536,
	} satisfies Model<"openai-completions">,
	...
	"google/gemini-3.7-flash:batch": {
		...
		thinkingLevelMap: {"off":null,"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null,"max":null},
		input: ["text", "image", "video", "file", "audio"],
		cost: {"input":0.1875,"output":0.9375,"cacheRead":0.01875,"cacheWrite":0.020833},
		contextWindow: 1048576,
		maxTokens: 65536,
	} satisfies Model<"openai-completions">,
	...
	"inclusionai/ling-3.0-flash": {
		...
		reasoning: true,
		input: ["text"],
		cost: {"input":0.021,"output":0.063,"cacheRead":0.0042,"cacheWrite":0},
		contextWindow: 262144,
		maxTokens: 32768,
	} satisfies Model<"openai-completions">,
	...
	"meta/muse-glimmer-30b": {
		...
		input: ["text", "image"],
		cost: {"input":0.3,"output":1.2,"cacheRead":0.04,"cacheWrite":0},
		contextWindow: 131072,
		maxTokens: 16384,
	} satisfies Model<"openai-completions">,
	...
	"mistralai/mistral-medium-3-5:batch": {
		...
		input: ["text", "image", "file"],
		cost: {"input":0.75,"output":3.75,"cacheRead":0,"cacheWrite":0},
		contextWindow: 262144,
		maxTokens: 209715,
	} satisfies Model<"openai-completions">,
	...
	"mistralai/mistral-medium-3.1:batch": {
		...
		reasoning: false,
		input: ["text","image"],
		cost: {"input":0.4,"output":2,"cacheRead":0.04,"cacheWrite":0},
		contextWindow: 131072,
		maxTokens: 104857,
	} satisfies Model<"openai-completions">,
	...
	"nvidia/nemotron-3.5-lightning": {
		...
		reasoning: true,
		input: ["text"],
		cost: {"input":0.08,"output":0.2,"cacheRead":0.04,"cacheWrite":0},
		contextWindow: 262144,
		maxTokens: 131072,
	} satisfies Model<"openai-completions">,
	...
	"poolside/laguna-s-2.1": {
		...
		reasoning: true,
		input: ["text"],
		cost: {"input":0.09,"output":0.18,"cacheRead":0.009,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 131072,
	} satisfies Model<"openai-completions">,
	...
	"qwen/qwen3.8-2.4t-a95b:batch": {
		...
		thinkingLevelMap: {"off":null,"minimal":null,"low":"low","medium":"medium","high":null,"xhigh":"xhigh","max":null},
		input: ["text"],
		cost: {"input":2.5,"output":6.25,"cacheRead":0.5,"cacheWrite":0},
	...
	"thinkingmachines/inkling": {
		...
		compat: {"supportsDeveloperRole":false,"thinkingFormat":"openrouter"},
		reasoning: true,
		thinkingLevelMap: {"off":"none","minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":null,"max":"max"},
	...
	"upstage/solar-pro4": {
		...
		reasoning: true,
		input: ["text"],
		cost: {"input":0.03,"output":0.12,"cacheRead":0.006,"cacheWrite":0},
		contextWindow: 524288,
		maxTokens: 131072,
	} satisfies Model<"openai-completions">,
	"x-ai/grok-4.20": {
	...
	"~deepseek/deepseek-v4-flash-latest": {
		...
		thinkingLevelMap: {"off":"none","minimal":null,"low":null,"medium":null,"high":"high","xhigh":"xhigh","max":null},
		input: ["text"],
		cost: {"input":0.03,"output":0.16,"cacheRead":0.013,"cacheWrite":0},
		contextWindow: 1048576,
		maxTokens: 393216,
	} satisfies Model<"openai-completions">,
	...
	"~z-ai/glm-latest": {
		...
		thinkingLevelMap: {"off":null,"minimal":null,"low":"low","medium":null,"high":"high","xhigh":null,"max":"max"},
		input: ["text"],
		cost: {"input":1.1875,"output":4.18,"cacheRead":0.247,"cacheWrite":0},
		contextWindow: 262144,
		maxTokens: 131072,
	} satisfies Model<"openai-completions">,
} as const;
