...
import { getAgentDir, ModelRuntime } from "@aicontainer/agent";
...
export type AgentSessionDriverOptions = Omit<AgentRuntimeManagerOptions, "agentDir" | "modelRuntime"> & {
    agentDir?: string;
...
export class AgentSessionDriver implements AgentDriver<"agent"> {
    ...
    constructor(options: AgentSessionDriverOptions = {}) {
        ...
        this.#modelRuntime = Promise.resolve(
