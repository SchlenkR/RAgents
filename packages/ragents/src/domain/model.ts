...
export type SubscriptionStatus = "active" | "removed" | "failed";
...
export type ActionKind = "action" | "question";
...
export type Action = {
    ...
    | { kind: "action" }
    | { kind: "question"; question: ActionQuestion | null }
);
...
export type RunView = Omit<RunState, Collections> & {
    actors: Actor[];
    inputs: ActorInput[];
    turns: Turn[];
...
export const isExecutableActor = (actor: Actor): actor is ExecutableActor => actor.kind !== "human";
