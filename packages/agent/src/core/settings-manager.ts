import type { ThinkingLevel } from "@aicontainer/agent-core";
import type { Transport } from "@aicontainer/ai";
...
export interface Settings {
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for agent-managed HTTP clients
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.AGENT_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.AGENT_HARDWARE_CURSOR === "1";
	}
