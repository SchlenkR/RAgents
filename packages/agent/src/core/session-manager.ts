import { type AgentMessage, uuidv7 } from "@aicontainer/agent-core";
import type { Message, TextContent, UserContent } from "@aicontainer/ai";
 ...
 * Encodes cwd into a safe directory name under ~/.agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.agent/sessions/<encoded-cwd>/).
	 */
