...
import * as builtinProviderCatalog from "@aicontainer/ai/providers/all";
...
export class ModelRuntime implements Models {
	...
	static async create(options: CreateModelRuntimeOptions = {}): Promise<ModelRuntime> {
		...
		const runtime = new ModelRuntime(credentials, config, modelsPath, builtinProviderCatalog.builtinProviders());
