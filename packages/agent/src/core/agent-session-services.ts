...
import type { Model } from "@aicontainer/ai";
import { getAgentDir } from "../config.ts";
import { resolvePath } from "../utils/paths.ts";
import type { ExtensionFactorySettlementObserver, SessionStartEvent, ToolDefinition } from "./extensions/index.ts";
...
export async function createAgentSessionServices(
	...
	if (options.signal?.aborted) {
		extensionsResult.runtime.invalidate("Extension creation was aborted.");
		options.signal.throwIfAborted();
	}
