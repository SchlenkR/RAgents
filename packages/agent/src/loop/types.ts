...
export interface AgentLoopConfig extends SimpleStreamOptions {
	...
	/** Customize an unavailable tool's error text; undefined keeps the default and execution stays blocked. */
	formatUnknownToolError?: (toolName: string) => string | undefined;
 ...
 * thinking-level metadata from @ragents/ai to detect support for a concrete model.
 */
export type ThinkingLevel = "off" | "minimal" | "low" | "medium" | "high" | "xhigh" | "max";

/** Custom message types; `core/messages.ts` adds them through declaration merging. */
