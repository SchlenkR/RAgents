...
export interface AgentOptions {
	...
	formatUnknownToolError?: AgentLoopConfig["formatUnknownToolError"];
...
export class Agent {
	...
	public formatUnknownToolError?: AgentLoopConfig["formatUnknownToolError"];
	...
	constructor(options: AgentOptions = {}) {
		...
		this.formatUnknownToolError = options.formatUnknownToolError;
	...
	private createLoopConfig(options: { skipInitialSteeringPoll?: boolean } = {}): AgentLoopConfig {
		...
		return {
			...
			formatUnknownToolError: this.formatUnknownToolError,
